...
class qimai_demo(object):
    ...
    def get_app_list(self):
        ...
        print('app_list 代理为：{}'.format(req.text))
    ...
    def spider(self):
        while not self.page_queue.empty():
            ...
            options = webdriver.ChromeOptions()
            options.add_argument("--proxy-server={}".format(req.text))
            print('app 代理为：{}'.format(req.text))
            app_driver = webdriver.Ie(executable_path=r'C:\IEDriverServer_x64_2.45.0\IEDriverServer.exe')
            ...
            try:
                ...
                # 最新版本发布日期
                version_date_l = app_tree.xpath("//*[@id='app-container']/div[1]/div[2]/div[2]/div[9]/div[2]/text()")
